  ...
  return (
    ...
    <div class="container">
        <form class="row g-3 rounded-4 shadow p-5">
            <div class="col-md-6">
              <label for="inputProduto4" class="form-label">Produto</label>
              <input type="produto" class="form-control" id="inputProduto4" />
            </div>
            <div class="col-md-6">
              <label for="inputobs4" class="form-label">Observação</label>
              <input type="obs" class="form-control" id="inputobs4" />
            </div>
            <div class="col-md-4">
                <label for="inputState" class="form-label">Unidade</label>
                <select id="inputState" class="form-select">
                  <option selected></option>
                  <option>ITB Belval</option>
                  <option>ITB Paulista</option>
                  <option>ITB Imperial</option>
                </select>
              </div>
              <div class="col-md-4">
...
export default ProdutoColetadoNovo;