    ...
    <div>
      ...
      <div class="container">
        <form class="row g-3 rounded-4 shadow p-5">
            ...
            <div class="col-md-6">
              <label for="inputDataColeta" class="form-label">Data da coleta</label>
              <input type="Data da coleta" class="form-control" id="inputDataColeta"/>
            </div>
            <div class="col-12">
              <label for="inputStatusColeta" class="form-label">Status da Coleta</label>
              <input type="Status da Coleta" class="form-control" id="inputStatusColeta" placeholder="Posto de Coleta"/>
            </div>
            <div class="col-md-4">
              ...
              <select id="inputState" class="form-select">
                ...
                <option>Johnatan</option>
                <option>Isaac</option>
                <option>Beatriz</option>
              </select>
            </div>
            <div class="col-md-6">
                <label for="inputColeta" class="form-label">Posto de Coleta</label>
                <input type="Posto de Coleta" class="form-control" id="inputColeta"/>
              </div>
            <div class="col-12">
